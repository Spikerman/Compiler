...
using Compiler.UI.AwaitableUI;

namespace Compiler.UI.Controls.Extensions
{
    /// <summary>
    ...
    {
        private static readonly TimeSpan DefaultAnimatedScrollDuration = TimeSpan.FromSeconds(0.5);
